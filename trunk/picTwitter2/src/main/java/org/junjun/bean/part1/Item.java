...
public class Item
{
	...
	// item
	private String id="";
	private String tag=""; // pic,animal , cute or ....
	...
	private int total = 0;
	private String user = "";  // where is the item from
	...
	public String toString() {
		return this.id +", "+this.tag+", "+this.getCata()+","+this.getDate()+", "+this.getUrl()+", "+this.getDesc();
	}
