...
public class Querys {
	...
	/**
	 * test AddDocuments the "create" variable of indexWriter constructor must
	 * be "false" IndexWriter(Directory d, Analyzer a, boolean create,
	...
	/**
	 * query with a expression like "+city +bridge"
	 * 
	 * @param fieldName
	 * @param searchString
	 * @throws CorruptIndexException
