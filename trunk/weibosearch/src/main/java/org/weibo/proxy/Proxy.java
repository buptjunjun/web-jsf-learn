...
/**
 * if we frequently visit one website, we may end up with a block the site.
...
public class Proxy implements Callable<Integer> ,Comparable
{
	...
	public Proxy( String ip , int port ,String testUrl )
	{
		this.ip = ip;
		this.port =port;
	...
	{
	  return this.ip +":"+this.port+ ","+" : responding time:"+this.connectTime;
	}
