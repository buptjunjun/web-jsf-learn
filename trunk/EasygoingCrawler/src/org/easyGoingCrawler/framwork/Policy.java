 ...
 * For example PolicyURL is an implemetation of Policy. It will make decision if one url will be accepted .
 * for example , when we choose one url from "url store"(maybe in a database , it all depends), 
 * and want to fetch the html of it.  PolicyURL will decide whether to abandon it 
