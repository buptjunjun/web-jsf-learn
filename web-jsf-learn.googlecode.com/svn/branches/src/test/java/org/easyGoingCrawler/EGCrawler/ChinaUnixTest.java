...
public class ChinaUnixTest
{
	...
	public void TestCrawler()
	{
		...
		EGCrawler crawler = appcontext.getBean("ChinaUnixcrawler",EGCrawler.class);
	...
	public void TestBlog()
	{
		...
		q_chinaunix.sort().on("date", Order.DESCENDING);
	...
	public void TestBloger()
	{
		...
		List<Bloger> bloger = Mongo.mongoOps.find( q_chinaunix,Bloger.class);
		for (Bloger b:bloger)
		{
			System.out.println(b);
			//break;
