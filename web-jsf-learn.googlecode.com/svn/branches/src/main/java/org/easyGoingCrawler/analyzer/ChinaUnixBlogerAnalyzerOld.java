...
public class ChinaUnixBlogerAnalyzerOld implements Analyzer<Bloger>
{
	private Pattern pattern= Pattern.compile("\\d+");
	public ChinaUnixBlogerAnalyzerOld()
	{
	...
	static public void main(String [] args)
	{
		...
		Bloger bloger = new ChinaUnixBlogerAnalyzerOld().analyze(null, "utf-8", curl.getContent());
