...
public class BaseSearcher implements Searcher
{
    ...
    public BaseSearcher(BaseLucene baselucene)
	{
    	analyzer  = baselucene.getAnalyzer();
    	this.baselucene = baselucene;   	
	    searcher = baselucene.getSearcher();
	...
	public void refresh() {
			...
			new Thread()
			{
				...
				public void run() 
				{
					IndexWriter writer = baselucene.getWriter();
					...
					synchronized(writer)
					{
						...
						newSearcher = nrtManager.acquire();
					}
