...
public class RotateHostURLSchedulerMovieTest
{
...
//		System.out.println(curl.getIncludeURLs());
		...
		URLScheduler urlscheduler = appcontext.getBean("RotateHostURLSchedulerMovie", RotateHostURLSchedulerMovie.class);
