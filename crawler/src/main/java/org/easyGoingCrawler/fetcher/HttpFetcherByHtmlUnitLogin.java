...
public class HttpFetcherByHtmlUnitLogin extends Fetcher
{
	Logger loger = Logger.getLogger(HttpFetcherByHtmlUnitLogin.class);
	...
	public HttpFetcherByHtmlUnitLogin(String loginInfoFile) throws FileNotFoundException, IOException
	{
		// TODO Auto-generated constructor stub
		this(false,loginInfoFile);
	}
	
	public HttpFetcherByHtmlUnitLogin(boolean enableJs,String loginInfoFile) throws FileNotFoundException, IOException
	{
		// TODO Auto-generated constructor stub
		this(enableJs ,3,10,loginInfoFile);
	}
   
	public HttpFetcherByHtmlUnitLogin(boolean enableJs, int jsTimeout, int conTimeout,String loginInfoFile) throws FileNotFoundException, IOException
	{
		...
		// TODO Auto-generated constructor stub
		webClient = FetcherUtil.getLoginedWebClinet(loginInfoFile);
...
//		Fetcher fetcher = appcontext.getBean("fetcher",Fetcher.class);
		...
		Fetcher fetcher = new HttpFetcherByHtmlUnitLogin("test");
