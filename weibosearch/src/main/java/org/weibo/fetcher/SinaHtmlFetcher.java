 ...
 *
 */
public class SinaHtmlFetcher implements Fetcher
{
    Logger logger = Logger.getLogger(SinaHtmlFetcher.class);
    ...
    public SinaHtmlFetcher()
    {
            // TODO Auto-generated constructor stub
            this(false);
    }
    
    public SinaHtmlFetcher(boolean enableJs)
    {
            // TODO Auto-generated constructor stub
            this(enableJs ,3,10);
    }

    public SinaHtmlFetcher(boolean enableJs, int jsTimeout, int conTimeout)
    {
